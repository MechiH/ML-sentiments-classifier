...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    """
    return max(0,1-label*(theta.dot(feature_vector)+theta_0));    
#pragma: coderesponse end
...
def perceptron_single_step_update(
    ...
    """
    # Your code here   
    if (label*(current_theta.dot(feature_vector)+current_theta_0)<=0.01):
...
def average_perceptron(feature_matrix, labels, T):
    ...
    current_theta_0=0
    s=0
    d=np.zeros(feature_matrix.shape[1])
...
def pegasos_single_step_update(feature_vector,label,L,eta,current_theta,current_theta_0):
    ...
    """
    # Your code here
    #print(label*(current_theta.dot(feature_vector)+current_theta_0))
...
def classify(feature_matrix, theta, theta_0):
    ...
    """
    # Your code here
    n=np.zeros(feature_matrix.shape[0])
...
def classifier_accuracy(
    ...
    s=classify(train_feature_matrix,theta,theta_0)
    d=classify(val_feature_matrix,theta,theta_0)
    return(accuracy(s,train_labels),accuracy(d,val_labels))
#pragma: coderesponse end
